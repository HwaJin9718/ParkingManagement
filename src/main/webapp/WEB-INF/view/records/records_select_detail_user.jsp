					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="button-container">
								<button
									onclick="location.href = './RecordsSelectUser.hw?'">전체
									목록</button>
									<!--  세션기능 추가된 경우 button 내 onclick="location.href = './RecordsSelectUser.hw?member_code=${sessionScope.member_code}'" 해당 내용으로 수정 -->
							</div>
						</div>
					</div>
				</div>
