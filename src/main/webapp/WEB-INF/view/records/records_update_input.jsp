					...
					<div class="card">
						...
						<div class="card-body">
							...
							<form action="./RecordsUpdateInput.hw" method="post"
								name="records_update" id="update">
								<fieldset>

									<div class="form-group row">
										<label for="records_code" class="col-4 col-form-label pr-0">
											<i class="fas fa-user-plus mr-sm-1"></i>주차 기록 코드 번호 :
										</label>
										<div class="col-8 pl-0">
											<input type="text" name="records_code" id="records_code"
												class="form-control" value="${recordsDTO.records_code}"
												readonly>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-8 pl-0">
											<input type="text" name="parking_code" id="parking_code"
												class="form-control" value="${recordsDTO.parking_code}"
												readonly>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-8 pl-0">
											<input type="text" name="parking_name" id="parking_name"
												class="form-control" value="${recordsDTO.parking_name}"
												readonly>
										</div>
									</div>
									...
									<div class="form-group row">
										<label for="member_code" class="col-4 col-form-label pr-0">
											<i class="fas fa-user-plus mr-sm-1"></i>사용자 코드 :
										</label>
										<div class="col-8 pl-0">
											<input type="text" name="member_code" id="member_code"
												class="form-control" value="${recordsDTO.member_code}"
												readonly>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-8 pl-0">
											<input type="text" name="member_car_num" id="member_car_num"
												class="form-control" value="${recordsDTO.member_car_num}"
												readonly>
										</div>
									</div>
									...
									<div class="form-group row">
										<label for="records_start" class="col-4 col-form-label pr-0">
											<i class="fas fa-user-plus mr-sm-1"></i>입차시간 :
										</label>
										<div class="col-8 pl-0">
											<input type="text" name="records_start" id="records_start"
												class="form-control" value="${recordsDTO.records_start}"
												readonly>
										</div>
									</div>
									...
									<div class="form-group row">
										<label for="records_end" class="col-4 col-form-label pr-0">
											<i class="fas fa-user-plus mr-sm-1"></i>출차 시간 :
										</label>
										<div class="col-8 pl-0 form-control">수정시간으로 자동 입력됩니다.</div>
									</div>

									<div class="form-group row">
										<label for="payment_total" class="col-4 col-form-label pr-0">
											<i class="fas fa-user-plus mr-sm-1"></i>결제 금액 :
										</label>
