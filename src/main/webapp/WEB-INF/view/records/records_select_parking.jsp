...
<body>
	...
	<div class="button-container">
		...
		<button
			onclick="location.href ='./RecordsInsertInput.hw?parking_code=${parking_code}&parking_name=${parking_name}'">주차
			기록 등록</button>
	</div>
								...
								<tbody>
									...
									<c:forEach var="arrayList" items="${arrayList}">
										<tr class="text-center">
											...
											<td><a
												href="./RecordsSelectDetailParking.hw?records_code=${arrayList.records_code}">상세
													정보 보기</a></td>
										</tr>
									</c:forEach>
