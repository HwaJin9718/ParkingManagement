						...
						<div class="card-body">
							...
							<div class="form-group row">
								<div class="col-4 col-form-label pr-0">
									<i class="fas fa-user-plus mr-sm-1"></i>주차 기록 코드 :
								</div>
							...
							<div class="form-group row">
								<div class="col-4 col-form-label pr-0">
									<i class="fas fa-user-plus mr-sm-1"></i>차량 번호 :
								</div>
							...
							<div class="form-group row">
								<div class="col-4 col-form-label pr-0">
									<i class="fas fa-user-plus mr-sm-1"></i>결제 요금 :
								</div>
							...
							<div class="button-container">
								...
								<button
									onclick="location.href = './RecordsSelectParking.hw?parking_code=${recordsDTO.parking_code}&parking_name=${recordsDTO.parking_name}'">주차
									기록 목록</button>
								<button
									onclick="location.href = './RecordsUpdate.hw?records_code=${recordsDTO.records_code}'">수정</button>
								<button
									onclick="location.href = './RecordsDelete.hw?records_code=${recordsDTO.records_code}&parking_code=${recordsDTO.parking_code}&parking_name=${recordsDTO.parking_name}'">삭제</button>
