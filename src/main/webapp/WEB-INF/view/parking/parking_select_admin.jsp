...
<body>
	...
	<div class="button-container">
		...
		<button onclick="location.href ='./ParkingInsertInput.hj'">주차장
			등록</button>
	</div>
								...
								<tbody>
									...
									<c:forEach var="arrayList" items="${arrayList}">
										<tr class="text-center">
											...
											<td>
												<button
													onclick="location.href = './ParkingSelectDetail.hj?parking_code=${arrayList.parking_code}'">상세보기</button>
												<button
													onclick="location.href = './RecordsSelectParking.hw?parking_code=${arrayList.parking_code}&parking_name=${arrayList.parking_name}'">
													주차 기록 보기</button>
											</td>
										</tr>
									</c:forEach>
