...
<body>
	...
	<button onclick="location.href ='./ParkingSelectAll.hj'">주차장 목록으로 이동하기(manager)</button>
	</div>
									...
									<div class="form-group row">
										...
										<div class="col-8 pl-0">
											<input type="text" name="parking_address"
												...
												value="${parkingDTO.parking_address}">
										</div>
										<div class="col-4"></div>
									...
									<div class="form-group row">
										...
										<div class="col-8 pl-0">
											<input type="text" name="parking_latitude"
												...
												value="${parkingDTO.parking_latitude}">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-8 pl-0">
											<input type="text" name="parking_longitude"
												...
												value="${parkingDTO.parking_longitude}">
										</div>
									</div>
