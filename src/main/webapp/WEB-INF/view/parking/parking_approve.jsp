						...
						<div class="card-body">
							...
							<div class="form-group row">
								<div class="col-form-label pr-0">
									<i class="fas fa-user-plus mr-sm-1"></i>${parkingDTO.parking_code}번의
									주차장을 승인 하시겠습니까?
								</div>
							</div>
							...
							<nav class="navbar justify-content-end">
								<button
									onclick="location.href = './ParkingApproveProcess.hj?parking_code=${parkingDTO.parking_code}&parking_approval=AP'"
									class="btn btn-outline-primary mr-sm-1">
									<i class="fas fa-save mr-sm-1"></i> 승인
								</button>
								<button onclick="location.href = './ParkingSelectAll.hj'"
									id="clear" class="btn btn-outline-warning mr-sm-1">
