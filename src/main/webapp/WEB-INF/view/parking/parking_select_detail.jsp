					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="button-container">
									<button onclick="location.href = './ParkingSelectAll.hj'">주차장 목록(manager)</button>
									<button onclick="location.href = './ParkingSelectAdmin.hj'">주차장 목록(admin)</button>
								<button
									onclick="location.href = './ParkingUpdate.hj?parking_code=${parkingDTO.parking_code}'">수정(manager)</button>
								<button
									onclick="location.href = './ParkingDelete.hj?parking_code=${parkingDTO.parking_code}'">삭제(manager)</button>
									<button
										onclick="location.href = './ParkingApprove.hj?parking_code=${parkingDTO.parking_code}'">승인(admin)</button>
							</div>
						</div>
					</div>
				</div>
